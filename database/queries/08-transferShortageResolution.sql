-- =============================================================================
-- 08-transferShortageResolution.sql
-- Sistema de Inventario Multi-Sucursal — OptiPlant Consultores
--
-- Paso 5 del flujo de transferencias (sección 3.4 del PDF): tras una recepción
-- parcial hay que "definir el tratamiento" del faltante — reenvío, ajuste o
-- reclamación. Se guarda la decisión en la propia transferencia. Si el
-- tratamiento es reenvío (RESHIPMENT), el backend crea una transferencia de
-- seguimiento en estado REQUESTED por las cantidades faltantes y deja el
...
-- OPC-back/src/main/resources/db/migration/V8__transfer_shortage_resolution.sql.
-- =============================================================================
